                ...
                <div class="bg-white dark:bg-neutral-900 w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl transform scale-95 transition-transform duration-300 relative"
                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <div class="mt-8 pt-6 border-t border-neutral-100 dark:border-neutral-800 flex justify-end">
                            <button onclick="navigator.clipboard.writeText('{{ route('landing.announcements.detail', $announcement->slug ?? $announcement->id) }}'); alert('Link berhasil disalin!');" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-emerald-50 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-400 dark:hover:bg-emerald-900/50 transition-colors text-sm font-bold gap-2">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
