...
@section('meta_description', Str::limit(strip_tags($activity->description), 150))
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div class="w-full lg:w-8/12 bg-white dark:bg-neutral-900 rounded-xl shadow-sm border border-neutral-100 dark:border-neutral-800 p-6 sm:p-8" data-aos="fade-up">
                ...
                <!-- Share Section -->
                <div class="mt-12 pt-6 border-t border-neutral-100 dark:border-neutral-800 flex items-center">
