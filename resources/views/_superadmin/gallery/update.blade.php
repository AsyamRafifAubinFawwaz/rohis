...
@section('content')
    <div class="grid grid-cols-1 gap-4">
        <div
            ...
            <form navigate-form action="{{ route('superadmin.galleries.doUpdate', $gallery->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        ...
                        <!-- Kegiatan -->
                        <div>
                            <label for="activity_id" class="block text-sm font-medium mb-2 dark:text-white">Tautkan ke Kegiatan (Opsional)</label>
                    ...
                    <div class="space-y-4">
                        <!-- Foto -->
                        <x-admin.file-upload name="image" id="image" label="Ubah Foto" :value="$gallery->image" />
                    </div>
                </div>
