...
@section('content')
    <div class="grid grid-cols-1 gap-4">
        <div
            ...
            <form navigate-form action="{{ route('superadmin.announcements.create') }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" id="expires_at" name="expires_at" value="{{ old('expires_at') }}"
                                ...
                                required title="Pilih tanggal pengumuman ini tidak lagi ditampilkan secara utama">
                            @error('expires_at')
                                <p class="text-xs text-red-600 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <!-- Gambar -->
                        <x-admin.file-upload name="image" id="image" label="Gambar/Banner Pengumuman" />
                    </div>
                </div>
