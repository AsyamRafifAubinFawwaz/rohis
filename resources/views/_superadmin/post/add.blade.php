...
@section('content')
    <div class="grid grid-cols-1 gap-4">
        <div
            ...
            <form navigate-form action="{{ route('superadmin.posts.create') }}" method="POST" enctype="multipart/form-data"
                class="p-6">
                @csrf
                <div class="space-y-4">
                    <!-- Form Group -->
                    ...
                    <!-- Form Group -->
                    <x-admin.file-upload name="thumbnail" id="thumbnail" label="Gambar Postingan" />
                    <!-- End Form Group -->
                </div>
