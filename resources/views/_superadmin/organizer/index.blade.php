            ...
            <form id="filter-form" action="{{ route('superadmin.organizer.index') }}" method="GET" navigate-form
                ...
                <div class="w-full lg:w-48">
                    ...
                    <select name="periode" id="periode"
                        class="py-2.5 px-4 block w-full border-gray-200 rounded-xl text-sm focus:border-brand focus:ring-brand dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600 shadow-sm cursor-pointer">
