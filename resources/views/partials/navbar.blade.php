...
<nav id="landing-navbar"
    class="fixed top-4 inset-x-0 z-[90] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-300">
    
    <div class="flex items-center justify-between h-16 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-md rounded-2xl shadow-sm border border-neutral-200/50 dark:border-neutral-800/50 px-4 sm:px-6">
    ...
    {{-- Mobile Menu --}}
    <div id="mobile-menu" class="hidden lg:hidden mt-2 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md border border-gray-200/50 dark:border-neutral-800/50 shadow-xl rounded-2xl overflow-hidden">
