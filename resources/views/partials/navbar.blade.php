...
<nav id="landing-navbar"
            ...
            <div class="hidden lg:flex items-center gap-x-1">
                ...
                <a href="{{ route('landing.index') }}"
                    class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                           {{ request()->routeIs('landing.index') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:text-brand hover:bg-brand/5' }}">
                    Beranda
                </a>
                ...
                <div class="relative group">
                    <button type="button"
                        class="flex items-center gap-x-1 px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                               {{ request()->is('profil/*') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:text-brand hover:bg-brand/5' }}">
                        Profil
                    ...
                    <div class="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2">
                        <div class="w-56 bg-white dark:bg-neutral-800 rounded-xl shadow-xl border border-gray-100 dark:border-neutral-700 overflow-hidden p-2">
                            <a href="{{ route('landing.index') }}#tentang"
                                class="flex items-center gap-x-3 px-3 py-2.5 rounded-lg text-sm text-gray-700 dark:text-neutral-300 hover:bg-brand/5 hover:text-brand transition-colors duration-150">
                                <span class="flex items-center justify-center size-8 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 text-brand">
                            ...
                            <a href="{{ route('landing.index') }}#visi-misi"
                                class="flex items-center gap-x-3 px-3 py-2.5 rounded-lg text-sm text-gray-700 dark:text-neutral-300 hover:bg-brand/5 hover:text-brand transition-colors duration-150">
                                <span class="flex items-center justify-center size-8 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600">
                                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <a href="{{ route('landing.index') }}#struktur"
                                class="flex items-center gap-x-3 px-3 py-2.5 rounded-lg text-sm text-gray-700 dark:text-neutral-300 hover:bg-brand/5 hover:text-brand transition-colors duration-150">
                                <span class="flex items-center justify-center size-8 rounded-lg bg-purple-50 dark:bg-purple-900/30 text-purple-600">
                                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                {{-- Program --}}
                <a href="{{ route('landing.index') }}#program"
                    class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                           {{ request()->is('program*') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:text-brand hover:bg-brand/5' }}">
                    Program
                </a>

                {{-- Artikel --}}
                <a href="{{ route('landing.index') }}#artikel"
                    class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                           {{ request()->is('artikel*') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:text-brand hover:bg-brand/5' }}">
                    Artikel
                </a>

                {{-- Galeri --}}
                <a href="{{ route('landing.index') }}#galeri"
                    class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                           {{ request()->is('galeri*') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:text-brand hover:bg-brand/5' }}">
                    Galeri
                </a>
                ...
                {{-- Aktivitas --}}
                <a href="{{ route('landing.index') }}#aktivitas"
                    class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-white dark:bg-neutral-900 border-t border-gray-100 dark:border-neutral-800 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <a href="{{ route('landing.index') }}"
                class="block px-4 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('landing.index') ? 'text-brand bg-brand/10' : 'text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-800' }}">
                Beranda
            </a>
            ...
            <div>
                ...
                <div id="mobile-profil-dropdown" class="hidden pl-4 mt-1 space-y-1">
                    <a href="{{ route('landing.index') }}#tentang"
                        class="block px-4 py-2 rounded-lg text-sm text-gray-600 dark:text-neutral-400 hover:text-brand hover:bg-brand/5">
                        Tentang Rohis
                    </a>
                    <a href="{{ route('landing.index') }}#visi-misi"
                        class="block px-4 py-2 rounded-lg text-sm text-gray-600 dark:text-neutral-400 hover:text-brand hover:bg-brand/5">
            ...
            <a href="{{ route('landing.index') }}#program"
                class="block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-800">
                Program
            </a>
            <a href="{{ route('landing.index') }}#artikel"
                class="block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-800">
